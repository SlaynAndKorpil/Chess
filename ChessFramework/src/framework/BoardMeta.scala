...
import framework.BoardStatus.GameResult.Win
import framework.BoardStatus.GameStatus.{Ended, GameStatus, PromoReq, StandardReq}
import framework.BoardStatus.ResultReason.WinResultReason.Resignation
